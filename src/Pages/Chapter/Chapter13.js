...
const Chapter1 = () => {
    ...
    const getVerse = async () => {
        const options = {
            method: 'GET',
            url: 'https://bhagavad-gita3.p.rapidapi.com/v2/chapters/13/verses/',
            headers: {
    ...
    return (
        <div className='cptMain'>
            ...
            <div className='cptMain1'>
                <div className="head"><p>Chapter No 13</p></div>
                <div className="subhead"><p>Ksetra Ksetrajna Vibhaaga Yoga</p></div>
                <div className="versesCount"><p>No of verse: 35</p></div>
            </div>
