...
const Chapter1 = () => {
    ...
    const getVerse = async () => {
        const options = {
            method: 'GET',
            url: 'https://bhagavad-gita3.p.rapidapi.com/v2/chapters/10/verses/',
            headers: {
    ...
    return (
        <div className='cptMain'>
            ...
            <div className='cptMain1'>
                <div className="head"><p>Chapter No 10</p></div>
                <div className="subhead"><p>Vibhooti Yoga</p></div>
                <div className="versesCount"><p>No of verse: 42</p></div>
            </div>
