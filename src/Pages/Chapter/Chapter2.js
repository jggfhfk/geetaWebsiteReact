    ...
    return (
        <div className='cptMain'>
            ...
            <div className='cptMain1'>
                <div className="head"><p>Chapter No 2</p></div>
                <div className="subhead"><p>Sankhya Yoga</p></div>
                <div className="versesCount"><p>No of verse: 72</p></div>
            </div>
                    ...
                    return (
                        <div data-aos="fade-up" className="verseBox" >
                            ...
                            <div className="verseMeaning">
                                <p>
                                    {i ? data[i - 1].translations[6].description : <div>loading</div>}
                                </p>
                            </div>
                        </div>
                    )
