...
const Chapter1 = () => {
    ...
    const getVerse = async () => {
        const options = {
            method: 'GET',
            url: 'https://bhagavad-gita3.p.rapidapi.com/v2/chapters/17/verses/',
            headers: {
    ...
    return (
        <div className='cptMain'>
            ...
            <div className='cptMain1'>
                <div className="head"><p>Chapter No 17</p></div>
                <div className="subhead"><p>Sraddhatraya Vibhaga Yoga</p></div>
                <div className="versesCount"><p>No of verse: 28</p></div>
            </div>
