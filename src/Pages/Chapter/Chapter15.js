...
const Chapter1 = () => {
    ...
    const getVerse = async () => {
        const options = {
            method: 'GET',
            url: 'https://bhagavad-gita3.p.rapidapi.com/v2/chapters/15/verses/',
            headers: {
    ...
    return (
        <div className='cptMain'>
            ...
            <div className='cptMain1'>
                <div className="head"><p>Chapter No 15</p></div>
                <div className="subhead"><p>Purushottama Yoga</p></div>
                <div className="versesCount"><p>No of verse: 20</p></div>
            </div>
